...
//     const { loading, data, error, refetch } = useQuery(GET_COLLECTIONS, { variables: { orderBy: activeSort, orderDirection }});
...
//             setOrderDirection(prev => prev === 'asc' ? 'desc' : 'asc'); // Toggle order direction
//         } else {
//             setActiveSort(sortType); // Update sorting criterion
//             setOrderDirection('asc'); // Reset to ascending order if sortType changes
//         }
//         console.log({activeSort});

//         // Refetch data with new sorting options
//         refetch({ 
//             orderBy: sortType,

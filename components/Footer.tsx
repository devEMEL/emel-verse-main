        ...
        <nav className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-zinc-400 hover:text-white transition-colors">Projects</a></li>
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-zinc-400 hover:text-white transition-colors p-2 rounded-full hover:bg-zinc-800/50">
                Twitter
              </a>
              <a href="#" className="text-zinc-400 hover:text-white transition-colors p-2 rounded-full hover:bg-zinc-800/50">
                Discord
